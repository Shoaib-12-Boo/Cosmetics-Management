    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to Cosmetics Managemnet</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Designed with both aesthetics and efficacy in mind, all of our products are also ethically-sourced, cruelty-free and lovingly made to be an essential part of a better, more beautiful daily ritual.</p>
              <p>We will deliver the carefully picked, best quality produce at your door step. At Costmetics Management, find a wide range of fresh products/creams, Shampoo etc at best price without any extra charges. Your desired item is just a click or call away.</p>
							<p>Our goal is to give the maximum satisfaction to our customer by our service and products with dedication.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_3.png);">
    	<div class="container">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text text-center">
                    ...
                    <p>Dr Sheraz</p>
                    <span class="position">Assistant Professors</span>
                  </div>
                </div>
              </div>
             <!--<div class="item">
